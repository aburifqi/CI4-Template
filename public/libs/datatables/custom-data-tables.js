...
function columnIcon(data, type, row, meta) {
  var strRender = `<span title="${row.nama}"><i class="${row.kode}"></i></span>`;
  return strRender;
}
//#endregion
...
function optionFonts() {
  return [
    {
      val: "fontawesome",
      text: "Font Awesome 6.4.2",
    },
    {
      val: "material design icons",
      text: "Material Design Icons 3.9.97",
    },
  ];
}
//#endregion
