...
function init_sidebar() {
	...
	$SIDEBAR_MENU.find('a').on('click', function (ev) {
		...
		if ($li.is('.active')) {
			...
			// 	} else {
			// 		if ($BODY.is(".nav-sm")) {
			// 			$li.find("li").removeClass("active active-sm");
			// 			// $li.find("li ul").slideUp();
			// 		}
			// 	}
			// });
			$li.addClass('active');
...
// $("li,a").not(this).on("click",function(e){
// 	e.stopPropagation();
	
// 	if($("body").hasClass("nav-sm")){
// 		console.log("kolik")
// 		console.log($(".render-menu.active").length)
// 		$(".render-menu.active").removeClass("active");
// 	}
// })
...
$(document).click(function (event) {
	...
	if (!$(event.target).closest("a").length) {
		$(".render-menu.active").removeClass("active");
		$(".render-menu.active-sm").removeClass("active-sm");
	}
});